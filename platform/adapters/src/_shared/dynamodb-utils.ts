 ...
 *
 * @returns The core table name (e.g., "noncegate-core-dev")
 ...
 *
 * @returns The base table name (e.g., "noncegate-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "noncegate-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "noncegate-app-realtime-dev")
