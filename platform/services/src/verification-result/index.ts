/**
 * VerificationResult Services - Application Layer Export
 *
...
/**
 * VerificationResult Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for verification-result domain.
 */
